...
def handle_question_groq():
    ...
    # Groq LLM
    groq_api_key = "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"  # Replace with your actual Groq API key
    ...
    return render_template('ask.html', question=question, answer=response['answer'], chat_history=chat_history)
